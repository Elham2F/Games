...
// دالة إظهار الرسالة المنبثقة الناعمة
...
function playCard(index) {
    ...
    if (selectedCard.color === activeCard.color || selectedCard.value === activeCard.value) {
        ...
        // استبدال الـ alert بالتنبيه المنبثق الأنيق
        showToast("❌ ما تقدر تلعب هذه الورقة! لازم نفس اللون أو نفس الرقم.");
    }
}
